 ...
 * Size component
 */
export const Size: React.FunctionComponent<{ printing: boolean }> = (props) => {
  ...
  return (
    <div style={{ breakInside: "avoid" }}>
      <ResultsCard title={titleLabel} functionName="size">
        {(data: ReportResult) => {
          ...
          const areaMetric = firstMatchingMetric(
            data.metrics,
            (m) =>
              m.sketchId === id && m.groupId === null && m.classId === "eez",
          );
            ...
            <ReportError>
              ...
              {isCollection && childProperties && (
                <Collapse
                  ...
                  key={props.printing + "Size MPA Collapse"}
              ...
              <Collapse
                title={t("Learn More")}
                key={props.printing + "Size LearnMore Collapse"}
                collapsed={!props.printing}
              >
                <Trans i18nKey="Size - learn more">
                  ...
                  <ul>
                    ...
                    <li>
                      Reef +100 (Inshore custom/coastal management areas):
                      0-100m beyond reefs, including specific sites beyond that
                      boundary where communities claim stewardship and governed
                      by traditional practices.
                    </li>
                  </ul>
                  <p>
                    📈 Report: This report calculates the total area of the area
                    of interest within various maritime boundaries. This value
                    is divided by the total area of the maritime zones to obtain
