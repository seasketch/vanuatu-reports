 ...
 * Mangroves component
 */
export const Mangroves: React.FunctionComponent<{ printing: boolean }> = (
  props,
) => {
  ...
  return (
    <div style={{ breakInside: "avoid" }}>
      <ResultsCard title={titleLabel} functionName="mangroves">
        {(data: ReportResult) => {
          ...
          return (
            <ReportError>
              ...
              <Collapse
                title={t("Learn More")}
                key={props.printing + "Mangroves LearnMore Collapse"}
