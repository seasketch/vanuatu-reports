...
/**
 * invertDensity: A geoprocessing function that calculates overlap metrics for vector datasources
 * @param sketch - A sketch or collection of sketches
 * @param extraParams
 * @returns Calculated metrics and a null sketch
 */
export async function invertDensity(
  sketch:
  ...
  const metricGroup = project.getMetricGroup("invertDensity");
...
export default new GeoprocessingHandler(invertDensity, {
  title: "invertDensity",
  description: "",
  timeout: 500, // seconds
